				...
				<div class="col-md-9">
								...
								<tr>
									...
									<td>
										...
										if ($a['file'] == "") { 
											...
											<a href="<?php echo base_url('admin/haki/tambah_dokumen/file/'. $a['id_haki']); ?>" class="btn btn-info btn-sm"><i class="fa fa-upload"></i>
												Unggah</a>
										...
										<?php if ($this->session->userdata['is_admin'] == 2) { ?>	
											<a title="Edit File Proposal" href="<?php echo base_url('admin/haki/tambah_dokumen/file/'. $a['id_haki']); ?>" class="btn btn-info btn-sm"><i class="fas fa-pencil-alt"></i>
										<?php }
										}
										?>
									</td>
					...
					<div class="card">
						<div class="card-header pl-3 pt-2 pb-2">
							...
							?>
								<a class="btn btn-warning btn-sm float-right" href="<?php echo base_url(); ?>admin/haki/tambah_kegiatan/<?= $a['id_haki']; ?>">
