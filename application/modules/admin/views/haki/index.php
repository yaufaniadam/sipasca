                  ...
                  <td class="text-center">
                    <?php if ($row['status'] == 0) { ?>
                      ...
                      <?php } else { ?>
                        ...
                        <a href="" style="color:#fff;" title="Restore" class="delete btn btn-xs btn-info" data-href="<?= base_url('admin/haki/restore/' . $row['id_haki']); ?>" data-toggle="modal" data-target="#confirm-restore"> <i class="fa fa-recycle"></i></a>
