    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <?php echo form_open_multipart(base_url('admin/pengabdian/tambah'), '' )?>
          <div class="card card-secondary">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input name="judul_pengabdian" value="<?php if(validation_errors()) {echo set_value('judul_pengabdian'); } ?>" type="text" id="judul" class="form-control" required="required">
              </div>
	...
	<div class="card card-secondary">
          ...
          <div class="card card-secondary">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input name="file_pengabdian" type="file" id="inputEstimatedBudget" class="form-control" required>
              </div>             
        ...
        <div class="col-md-12">
          ...
          <input type="submit" name="submit" value="Tambahkan Pengabdian" class="btn btn-success float-right">
        </div>
        <?php echo form_close(); ?>
      </div>
