...
<section class="content">
	...
	<?php
		foreach($edit_pengabdian->result_array() as $b){
	?>

	<div class="row">

		<div class="col-md-6">
			<?php echo form_open_multipart(base_url('admin/pengabdian/update'), '' )?>
			<div class="card card-secondary">
				...
				<div class="card-body">
					<div class="form-group">
						<label for="judul">Judul Pengambdian</label>
						<input name="judul_pengabdian" value="<?=$b['judul_pengabdian']; ?>" type="text" id="judul"
					...
					<div class="form-group">
						<label for="lokasi">Lokasi Pengabdian</label>
		...
		?>
					...
					?>
							...
							<input name="tgl_pelaksanaan" value="<?=$tgl_pelaksanaan;?>" type="text" class="form-control float-right"
								id="tanggal" required="required">
						</div>
						<!-- /.input group -->
					</div>
			...
			<div class="card card-secondary">
				...
				<div class="card-body">
					<div class="form-group">
						...
						<input name="file_pengabdian" type="file" id="inputEstimatedBudget" class="form-control">
						<input name="file_hidden" type="hidden" value="<?=$b['file'];?>" />
						<input name="id_pengabdian" type="hidden" value="<?=$b['id_pengabdian'];?>" />
		...
		<div class="col-md-12 p-30">
			<div class="form-group p-30">
				...
				<input type="submit" name="submit" value="Ubah Pengabdian" class="btn btn-success float-right">
			</div>
		</div>
		<?php echo form_close(); ?>
	</div>
