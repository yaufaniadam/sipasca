...
<section class="content-header">
	<div class="container-fluid">
	  ...
	  if($this->session->userdata('is_admin')==2)
			{ 
		?> <a href="<?= base_url('admin/pengabdian/tambah') ?>" class="btn btn-sm btn-default">Tambah baru</a>
					<?php
			}
		?>
				</h1>
	...
	<div class="row">
		<div class="col-12">
			...
			<div class="card">
				...
				<div class="card-body">
					<table id="tb_pengabdian" class="table table-bordered table-striped">
						<thead>
							<tr>
								<th style="width:40%">Judul Pengabdian</th>
					  ...
					  ?>
								...
								<td class="text-center">
									...
									<a href="" style="color:#fff;" title="Hapus" class="delete btn btn-xs btn-danger"
										data-href="<?=base_url('admin/pengabdian/hapus/'.$row['id_pengabdian']); ?>" data-toggle="modal"
										data-target="#confirm-delete"> <i class="fa fa-trash-alt"></i></a>

									<a class="btn btn-default btn-sm"
										href="<?=base_url('admin/pengabdian/edit/'.$row['id_pengabdian']); ?>">
                    <i class="fas fa-pencil-alt" style="color:green;"></i>
                    
									<?php } else { ?>

										<a href="" style="color:#fff;" title="Restore" class="delete btn btn-xs btn-info"
											data-href="<?=base_url('admin/pengabdian/restore/'.$row['id_pengabdian']); ?>" data-toggle="modal"
...
<script type="text/javascript">
  ...
  $('#confirm-restore').on('show.bs.modal', function (e) {
	...
	$("#pengabdian .semuapengabdian a.nav-link").addClass('active');
