...
<section class="content">
	...
	?>
		...
		<div class="row">
			...
			<div class="col-md-6">
				<?php echo form_open_multipart(base_url('admin/penelitian/update'), '') ?>
				<div class="card card-secondary">
					...
					<div class="card-body">
						<div class="form-group">
							...
							<input name="judul_penelitian" value="<?= $b['judul_penelitian']; ?>" type="text" id="judul" class="form-control" required="required">
						</div>
				...
				<div class="card card-secondary">
					...
					<div class="card-body">
						...
						<div class="form-group">
							...
							<input value="1" name="sumber_dana[]" type="checkbox" id="internal" data-toggle='collapse' data-target='.box_internal' <?php if (isset($sumber_dana[0]) && $sumber_dana[0] == 1) {
																																						echo "checked";
																																					} ?>> Internal &nbsp;
							&nbsp;
							<input value="2" name="sumber_dana[]" type="checkbox" id="eksternal" data-toggle='collapse' data-target='.box_external' <?php if (isset($sumber_dana[1]) && $sumber_dana[1] == 2) {
																																						echo "checked";
																																					} ?>> Eksternal
						</div>
