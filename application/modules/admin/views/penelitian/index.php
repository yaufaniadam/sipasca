			...
			<div class="card">
				...
				<div class="card-body">
					<table id="tb_penelitian" class="table table-bordered table-striped">
						...
						<tbody>
							...
							<tr>
								<td><a
										href="<?=base_url('admin/penelitian/detail/'.$row['id_penelitian']); ?>"><?=$row['judul_penelitian'];?></a>
								</td>
                ...
                <?php if($row['status'] == 0 ) { ?>
									...
									<a href="" style="color:#fff;" title="Hapus" class="delete btn btn-xs btn-danger"
										data-href="<?=base_url('admin/penelitian/hapus/'.$row['id_penelitian']); ?>" data-toggle="modal"
										data-target="#confirm-delete"> <i class="fa fa-trash-alt"></i></a>

									<a class="btn btn-default btn-sm"
										href="<?=base_url('admin/penelitian/edit/'.$row['id_penelitian']); ?>">
										<i class="fas fa-pencil-alt" style="color:green;"></i>
                  </a>
                <?php } else { ?>

                  <a href="" style="color:#fff;" title="Restore" class="delete btn btn-xs btn-info"
										data-href="<?=base_url('admin/penelitian/restore/'.$row['id_penelitian']); ?>" data-toggle="modal"
