...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1>Tambah Dokumentasi Kegiatan <a class="btn btn-warning btn-sm" href="<?= base_url('admin/penelitian/detail/' . $id_penelitian); ?>">Kembali</a></h1>
      </div>
      <div class="col-sm-6">
...
<section class="content">
  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <?php echo form_open_multipart(base_url('admin/penelitian/tambah_kegiatan_proses'), '') ?>

      <input name="id_penelitian" type="hidden" value="<?= $id_penelitian; ?>" />
      ...
      <div class="card card-secondary">
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <input name="nama" value="<?php if (validation_errors()) {
                                        echo set_value('nama');
                                      } ?>" type="text" id="nama" class="form-control">
          </div>
    ...
    <div class="col-md-12">
      <a href="<?= base_url('admin/penelitian/detail/' . $id_penelitian); ?>" class="btn btn-secondary">Batal</a>
  ...
  <div class="row">
    <div class="col-md-12">
      <table width="100%" class="table table-bordered table-striped" id="tb_penelitian">
        <thead>
          <tr>
            <th width="11%" class="text-center">No</th>
            <th width="40%" class="text-center">Nama Photo</th>
