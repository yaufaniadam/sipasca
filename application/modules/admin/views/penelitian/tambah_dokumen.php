...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1>Tambah Dokumen Penelitian <a class="btn btn-warning btn-sm" href="<?= base_url('admin/penelitian/detail/' . $id_penelitian); ?>"><i class="fa fa-arrow-circle-left"></i> Kembali</a></h1>
      </div>
      <div class="col-sm-6">
...
<section class="content">
  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <?php echo form_open_multipart(base_url('admin/penelitian/tambah_dokumen_proses'), '') ?>
