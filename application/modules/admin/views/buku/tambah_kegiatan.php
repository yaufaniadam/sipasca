    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
               <?php echo form_open_multipart(base_url('admin/buku/tambah_kegiatan_proses'), '' )?> 

    <input name="id_buku" type="hidden" value="<?=$id_buku;?>" />
        ...
        <div class="col-md-12">
          <a href="<?=base_url('admin/buku/detail/'.$id_buku);?>" class="btn btn-secondary">Batal</a>
     ...
     <div class="row">
      <div class="col-md-12">
       <table width="100%" class="table table-bordered table-striped" id="tb_buku">
                <thead>
                <tr>
     ...
     <a href="" style="color:#fff;" title="Hapus" class="delete btn btn-xs btn-danger" data-href="<?=base_url('admin/buku/hapus_kegiatan/'.$d['id_dokumentasi']); ?>" data-toggle="modal" data-target="#confirm-delete"> <i class="fa fa-trash-alt"></i></a>
