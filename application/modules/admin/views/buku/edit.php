			...
			<div class="card card-secondary">
				...
				<div class="card-body">
					<div class="form-group">
						...
						<input name="judul_buku" value="<?= $b['judul_buku']; ?>" type="text" id="judul" class="form-control"
							required="required">
					</div>
					<div class="form-group">
			...
			<div class="card card-secondary">
              ...
              ?>
						<input name="id_kategori_buku" type="radio" value="<?= $a['id_kategori_buku']; ?>" required="required"
							<?= ($a['id_kategori_buku'] == $b['kategori_buku'] ) ? 'checked="checked"' : ''; ?> />
						<?= $a['kategori_buku']; ?>
              ...
              ?>
						...
						<div class="form-group">
							...
							<input name="isbn" value="<?=(validation_errors()) ? set_value('isbn') :$b['isbn']; ?>" type="text" id="isbn"
								class="form-control" required="">
						</div>

						<div class="form-group">
							<label for="penerbit">Penerbit <span class="required">(Wajib diisi)</span></label>
							<input name="penerbit" value="<?=(validation_errors()) ? set_value('penerbit') :$b['penerbit']; ?>" type="text"
