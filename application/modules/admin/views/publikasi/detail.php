	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-3">
				...
				<div class="card card-olive card-outline">
          <div class="card-header box-profile">Reviewer
          </div>
					<div class="card-body box-profile">
			...
			<div class="col-md-9">
				...
				<div class="card">
                    ...
                    ?>
									<a href="<?php echo base_url(); ?><?= $a['file']; ?>" class="btn btn-warning btn-sm"><i
              ...
              ?>
						<a class="btn btn-warning btn-sm float-right"
							href="<?php echo base_url(); ?>admin/publikasi/tambah_kegiatan/<?= $a['id_publikasi']; ?>"> <i
								class="fas fa-image"></i> Tambah/Edit Dokumentasi</a>
						<?php
              } //if($a['hasil_penilaian']==1)
            } // endif is admin
              ?>
              ...
              ?>
					...
					<?php
          if ($a['link_publikasi'] == "") { ?>
					<a class="btn btn-success btn-lg btn-block disabled" target="_blank">Belum ada tautan menuju publikasi</a>
					<?php } else {
          ?>
					<a href="<?= $a['link_publikasi']; ?>" class="btn btn-success  btn-block btn-lg" target="_blank">Kunjungi
						tautan
						publikasi</a>
					<?php
          }
