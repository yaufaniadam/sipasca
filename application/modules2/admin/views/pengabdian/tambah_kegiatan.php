    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
               <?php echo form_open_multipart(base_url('admin/pengabdian/tambah_kegiatan_proses'), '' )?> 

    <input name="id_pengabdian" type="hidden" value="<?=$id_pengabdian;?>" />
        ...
        <div class="col-md-12">
          <a href="<?=base_url('admin/pengabdian/detail/'.$id_pengabdian);?>" class="btn btn-secondary">Batal</a>
     ...
     <div class="row">
      <div class="col-md-12">
       <table width="100%" class="table table-bordered table-striped" id="tb_pengabdian">
                <thead>
                <tr>
     ...
     <a href="" style="color:#fff;" title="Hapus" class="delete btn btn-xs btn-danger" data-href="<?=base_url('admin/pengabdian/hapus_kegiatan/'.$d['id_dokumentasi']); ?>" data-toggle="modal" data-target="#confirm-delete"> <i class="fa fa-trash-alt"></i></a>
